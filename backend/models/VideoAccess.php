...
class VideoAccess extends \yii\db\ActiveRecord
{
    ...
    public function getEcomOrder()
    {
        return $this->hasOne(EcomOrder::className(), ['invoice_number' => 'invoice_number']);
    }

    public function getEventAttendee()
    {
        return $this->hasOne(EventAttendee::className(), ['refer_id' => 'id']);
    }
}
