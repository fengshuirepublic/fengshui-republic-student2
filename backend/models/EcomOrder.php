...
class EcomOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(EcomPayerPaypal::className(), ['invoice_number' => 'invoice_number']);
    }

    public function getKiple()
    {
        return $this->hasOne(EcomPayerKiple::className(), ['invoice_number' => 'invoice_number']);
    }
}
