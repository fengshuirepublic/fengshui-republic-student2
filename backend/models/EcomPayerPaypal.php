...
/**
 * This is the model class for table "ecom_payer_paypal".
 *
 * @property int $id
 * @property int $status
 * @property int $count
 ...
 */
class EcomPayerPaypal extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(EcomOrder::className(), ['invoice_number' => 'invoice_number'])->andWhere(['status' => 1]);
    }
}
