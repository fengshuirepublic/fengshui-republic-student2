		...
		<div class="row">
			<div class="col-12 col-md-10 col-lg-9 mx-auto">
				<div id="bg-spark-s" class="row mb-sm-4 d-flex pb-5">
					<div class="col-12">
						<h5 class="text-center fsrepublic-text-white pt-5 pb-3 p-md-5">COURSES</h5>
					</div>
					<div class="col-12 col-md-5 col-lg-4">
						<img class="d-block d-md-none img-fluid w-70 mx-auto" src="../images/course/logo-course-en.png" alt="Fengshui Republic">
						<img class="d-none d-md-block d-lg-none img-fluid w-70 ml-auto" src="../images/course/logo-course-en.png" alt="Fengshui Republic">
						<img class="d-none d-lg-block img-fluid mx-auto" src="../images/course/logo-course-en.png" alt="Fengshui Republic">
					</div>
				...
				<div class="row">
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/fengshui') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">FENGSHUI<br>COURSE</h5>
					...
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/bazi') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">BAZI<br>COURSE</h5>
					...
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/qimen') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">QIMEN DUNJIA<br>COURSE</h5>
					...
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/yijing') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">YIJING<br>COURSE</h5>
					...
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/yiyanduan') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">YI YAN DUAN<br>COURSE</h5>
					...
					<div class="col-12 col-sm-6 px-0 px-sm-4 mb-sm-4">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/mianxiang') ?>">
							<h5 class="m-0 pt-3 pb-1 text-center fsrepublic-text-white course-title fsrepublic-gradient-brown">PHYSIOGNOMY<br>COURSE</h5>
