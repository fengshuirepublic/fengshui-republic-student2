...
<div class="container-fluid px-0 text-center">
	<div id="title">
		<h5 class="text-center fsrepublic-text-gold py-5 m-0">SERVICES</h5>
	</div>
	...
	<div class="container-fluid px-0 py-5">
		<div class="row mx-0 mb-5">
			<div class="col-12 mx-auto px-0 mb-5">
				<h5 class="text-center fsrepublic-text-white mb-5">COURSES</h5>
				<div class="row mx-0">
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/fengshui') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-fengshui-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/bazi') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-bazi-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/qimen') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-qimen-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/yijing') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-yijing-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/yiyanduan') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-yiyanduan-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
					<div class="col-6 px-0">
						<a href="<?= Yii::$app->urlManager->createUrl('courses/mianxiang') ?>">
							<img class="img-fluid w-100" src="../images/service/all-services/en-mianxiang-course.jpg" alt="Fengshui Republic">
						</a>
					</div>
				</div>
			</div>
