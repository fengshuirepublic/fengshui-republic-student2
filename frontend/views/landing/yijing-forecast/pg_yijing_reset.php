...
$this->title = Yii::t('app', 'Yi Jing Reset');
			...
			<form method="post" role="form">
				...
				<div class="form-row justify-content-center mb-4">
					<div class="col-sm-9 col-md-6 col-lg-5 col-xl-4">
						<input name="Yijing[username]" type="text" class="form-control" placeholder="Username" required>
					</div>
				</div>
				<div class="form-row justify-content-center mb-4">
					<div class="col-sm-9 col-md-6 col-lg-5 col-xl-4">
						<input name="Yijing[password]" type="password" class="form-control" placeholder="Password" required>
					</div>
				</div>
				<div class="form-row justify-content-center mb-4">
					<div class="col-sm-9 col-md-6 col-lg-5 col-xl-4">
						<input name="Yijing[access]" type="text" class="form-control" placeholder="New Access Code" required>
					</div>
				</div>
