	...
	<div class="container-fluid pb-2 pb-md-0" style="background-color: #000;">
		<div class="row">
			<div class="col-auto d-block d-md-none px-0">
				<button class="navbar-toggler navbar-toggler-right collapsed" type="button" data-toggle="collapse" data-target="#navbarCollapse" style="width: 64px;">
					<span></span>
					<span></span>
					<span></span>
					<!-- Menu -->
			...
			<div class="col-auto d-block d-md-none mx-auto mt-1">
			...
			<div class="col-auto d-block ml-0 ml-md-auto px-0">
				<a class="nav-link fsrepublic-text-white" href="<?= Yii::$app->urlManager->createUrl('lang?lang='.Yii::t('app', 'zh-CN')) ?>"><?= Yii::t('app', '中文') ?></a>
			</div>
		</div>
	</div>
							...
							<div class="row mt-2">
								<div class="col-12">
									<a class="px-1" href="<?= Url::to(['qimengeju/']) ?>" target="_blank">
										<span class="badge badge-gold">Qimen Geju</span>
									</a>
									<a class="px-1" href="<?= Url::to(['baziliunian/']) ?>" target="_blank">
										<span class="badge badge-gold">Bazi Liunian</span>
									</a>
								</div>
							</div>
						</div>
