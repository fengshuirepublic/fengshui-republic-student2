	...
	<div class="seq">
		<div class="seq-canvas">
			...
			<div class="seq-absolute seq-model-1-1">
				<img src="../images/products/title-en.png" class="d-flex mx-auto h-100 w-auto" alt="Fengshui Republic" />
			</div>
		</div>
	</div>
</div>

<nav id="categoryNav" class="navbar navbar-expand-lg px-0 py-0">
			...
			<div class="row">
				<div class="col-11 mx-auto">
					<ul class="navbar-nav nav-fill w-100">
						<li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#water-feature">WATER FEATURE</a>
						</li>
						<li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#primordial-spirit">PRIMORDIAL SPIRIT</a>
						</li>
						<li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#qimen-dunjia">QIMEN DUNJIA</a>
						</li>
						<li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#fulushou">FU LU SHOU</a>
						</li>
						<li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#magazine">MAGAZINE</a>
						</li>
						<!-- <li class="nav-item">
							<a class="nav-link fsrepublic-text-gold py-2" href="#auspicious-marriage-article">AUSPICIOUS MARRIAGE ARTICLE</a>
						</li> -->
					</ul>
				</div>
			</div>
...
<div class="container-fluid d-block d-lg-none" style="background-color: #DED7D0;">
	<div class="row">
		<div class="col-11 mx-auto">
				...
				<!-- <div>
					<p class="text-center my-2 mx-3">
						<a class="fsrepublic-text-gold py-2" href="#auspicious-marriage-article">
							<small>AUSPICIOUS MARRIAGE ARTICLE</small>
						</a>
					</p>
				</div> -->
			</div>
...
<div id="shopping-cart" language="en" csrf="<?= Yii::$app->request->getCsrfToken() ?>"></div>
