...
$this->registerJs('
	$(function() {
		$("#postageFee-info").popover({
			...
			trigger: "focus",
			placement: "top",
			content: "邮寄费用<ul class=\"pl-3\"><li>西马: RM 8.00</li><li>东马: RM 18.00</li><li>新加坡: RM 38.00</li></ul>",
		});
	});
', View::POS_END);
		...
		<div class="row">
			<div class="col-12 col-md-10 mx-auto">
				...
				<?php foreach ($new_order->items as $item): ?>
					...
					<hr>
				<?php endforeach; ?>
				<p class="text-right">小计: RM <span id="subtotal"><?= number_format($subtotal, 2) ?></span></p>
							...
							<div class="row">
								<div class="col-12 col-md-auto">
									<p class="my-2 text-right text-md-left">
										<i id="postageFee-info" class="fa fa-lg fa-info-circle mr-2" tabindex="0" data-toggle="popover"></i>邮寄费用
									</p>
								</div>
								<div class="col-12 col-md-auto">
									<select class="form-control" id="postageType" name="FormOrderProduct[postage_area]" data-quantity="<?= $qty_magazine ?>">
										<option value="singapore">新加坡</option>
										<option value="east_msia">东马 (沙巴，沙捞越)</option>
										<option value="west_msia">马来西亚半岛</option>
									</select>
								</div>
							</div>
						</div>
						<div class="col-12 col-md-auto">
							<p class="my-2 text-right">邮费总计: RM <span id="postageFee"></span></p>
						</div>
					</div>
				<?php endif; ?>
				<hr>
				<p class="text-right">总计: RM <span id="grand_total"></span></p>
				<hr class="mb-5">
				<div class="form-row">
					<div class="col-12 col-md-6 col-lg-3">
						<div class="form-group">
							<label for="checkout-collect_at">*领取地点</label>
							<select class="form-control" id="checkout-collect_at" name="FormOrderProduct[collect_at]" required>
								<option value="kl">吉隆坡办公司</option>
								<option value="jb">新山办公室</option>
							</select>
						</div>
					</div>
					<div class="col-12 col-md-6 col-lg-3">
						<div class="form-group">
							<label for="checkout-name">*名字</label>
							<input id="checkout-name" name="FormOrderProduct[name]" type="text" class="form-control" required>
						</div>
					</div>
					<div class="col-12 col-md-6 col-lg-3">
						<div class="form-group">
							<label for="checkout-email">*电邮</label>
							<input id="checkout-email" name="FormOrderProduct[email]" type="text" class="form-control" required>
						</div>
					</div>
					<div class="col-12 col-md-6 col-lg-3">
						<div class="form-group">
							<label for="checkout-phone">*电话</label>
				...
				<div class="form-row">
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							<label for="checkout-address_1">*地址 1</label>
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							<label for="checkout-address_2">*地址 2</label>
					...
					<div class="col-12 col-md-6 col-lg-4">
						<div class="form-group">
							<label for="checkout-address_3">地址 3</label>
				...
				<div class="row">
					<div class="col-12">
						<p>*所有的物品都需要亲临我们的办公所领取，除了书籍将被以邮寄的方式寄送出去。</p>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
						...
						<a href="<?php echo Url::to(['products/list', 'order' => 'cancel']) ?>" class="btn btn-default pull-right mr-2 align-self-center">取消</a>
					</div>
				</div>
			</div>
		</div>
