	...
	<div class="seq">
		<div class="seq-canvas">
			...
			<div class="seq-absolute seq-model-1-1">
				<img src="images/2019zodiac/title-cn.png" class="d-flex mx-auto h-100 w-auto">
			</div>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<img src="images/2019zodiac/rank-cn.png" class="img-fluid d-flex mx-auto">
		</div>
	</div>
	<div class="row">
		<div class="col-12 mx-auto">
			<div class="text-center py-5">
				...
				<?php else: ?>
					<a href="<?= Url::to(['2019zodiac-file/', 'file_name' => 'zodiac-cn.pdf']) ?>" class="btn btn-primary unlock-btn" target="_blank">
	...
	<div class="seq" style="height: 500px;">
		<div class="seq-canvas">
			...
			<div class="seq-absolute seq-model-2-2">
				<img src="images/2019zodiac/work-cn.png" class="d-flex mx-auto h-100 w-auto">
				<div class="text-center pt-4">
					<?php if (Yii::$app->user->isGuest): ?>
						<a href="<?= Url::to(['member/']) ?>" class="btn btn-primary unlock-btn"><i class="fa fa-lock" aria-hidden="true"></i> <?= Yii::t('app', 'Register | Login') ?></a>
					<?php else: ?>
						<a href="<?= Url::to(['2019zodiac-file/', 'file_name' => 'work-cn.pdf']) ?>" class="btn btn-primary unlock-btn" target="_blank">
							<i class="fa fa-lock" aria-hidden="true"></i> <?= Yii::t('app', 'Get Now') ?>
						</a>
					<?php endif; ?>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 col-md-4 offset-md-2">
				<img id="fs-position" src="images/2019zodiac/liu-nian-cn.png" class="img-fluid d-flex mx-auto" width="300">
				<div class="text-center py-4">
					<?php if (Yii::$app->user->isGuest): ?>
						<a href="<?= Url::to(['member/']) ?>" class="btn btn-primary unlock-btn"><i class="fa fa-lock" aria-hidden="true"></i> <?= Yii::t('app', 'Register | Login') ?></a>
					<?php else: ?>
						<a href="<?= Url::to(['2019zodiac-file/', 'file_name' => 'liu-nian-cn.pdf']) ?>" class="btn btn-primary unlock-btn" target="_blank">
							<i class="fa fa-lock" aria-hidden="true"></i> <?= Yii::t('app', 'Get Now') ?>
						</a>
					<?php endif; ?>
				</div>
